...
var CSVLink = (_temp = _class = function (_React$Component) {
  ...
  function CSVLink(props) {
    ...
    _this.downloadForMS = _this.downloadForMS.bind(_this);
    return _this;
  }
...
var isFunction = exports.isFunction = function isFunction(dataOrFn) {
...
var toCSV = exports.toCSV = function toCSV(dataOrFn, headers, separator) {
  var data = isFunction(dataOrFn) ? dataOrFn() : dataOrFn;
